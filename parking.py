...
#read image
img = cv2.imread('DB410c Workshop #0: Take Picture')
img2 = frame.copy()

#creates a template, its jsut a car sized patch of pavement
template = frame[138:165,484:495]
m, n, chan = frame.shape
...
f0 = plt.figure(4)
plt.imshow(cv2.cvtColor(frame,cv2.COLOR_BGR2RGB)),plt.title('Original')
